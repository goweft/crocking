...
For sensitive issues (anything that could expose users if disclosed publicly), use [GitHub's private vulnerability reporting](https://github.com/goweft/crocking/security/advisories/new) to disclose confidentially.
